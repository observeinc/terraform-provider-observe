...
// CollectJson does the same as Collect, but accepts a raw json string
func (g *Generator) CollectJson(jsonStr []byte) error {
	var data interface{}
...
// not depend on collection or response order.
