...
func TestBindingExportFailures(t *testing.T) {
	...
	ops := map[string][]string{
		"dashboard":         {bindingtest.OpListWorkspaces, datasetLookupOp},
		"worksheet":         {bindingtest.OpListWorkspaces, datasetLookupOp},
		"monitor":           {bindingtest.OpListWorkspaces, datasetLookupOp},
		"monitor_v2":        {bindingtest.OpListWorkspaces, datasetLookupOp, bindingtest.OpSearchMonitorV2Action},
		"monitor_v2_action": {bindingtest.OpListWorkspaces, bindingtest.OpListUsers},
	}
	for name, e := range exporters {
