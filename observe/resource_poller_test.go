		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.request.0.auth_scheme", "Digest"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.request.1.url", "https://example.com/path2"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.0.name", "now"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.0.format", "RFC822"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.0.truncate", "1s"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.1.name", "start"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.1.source", "now"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.1.format", "RFC822"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.1.offset", "1h"),
					resource.TestCheckResourceAttr("observe_poller.first", "http.0.timestamp.1.truncate", "1s"),
				),
			},
		},
	})
