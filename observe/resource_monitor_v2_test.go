		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("observe_monitor_v2.first", "rules.0.count.compare_values.0.compare_fn", "Greater"),
					resource.TestCheckResourceAttr("observe_monitor_v2.first", "rules.0.count.compare_values.0.value_int64", "0"),
