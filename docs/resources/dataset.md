...
"rematerialize", "skip_rematerialization", and "try_skip_rematerialization" - if no option is used, "rematerialize" is used by default. "skip_rematerialization" 
will skip rematerialization if certain conditions are met and fail otherwise. "try_skip_rematerialization" is similar to "skip_rematerialization" but will
