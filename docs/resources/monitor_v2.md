...
description: |-
  ...
  Monitors provide a configurable way to alert when conditions about incoming data are matched. These alerts can optionally also be forwarded to notification receivers like email and webhooks using shared or single-monitor actions to configure the template and destinations to configure the receiver.
---
# observe_monitor_v2
